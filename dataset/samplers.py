...
class DistributedDatasetBatchSampler(BatchSampler):
    """
    This batch sampler allows sampling batch data from a single dataset.
    Designed for use in a distributed training context.
    """
    def __init__(self, dataset, sampler, batch_size, drop_last, rank, world_size, wrap_last=False, gradient_accumulation_steps=None):
    ...
    def __iter__(self):
        # Create a BatchSampler to handle batching logic
